    ...
    hero: [
      {
        ...
        colors: [
          { color: 'rgba(56, 146, 179, 0.25)', stop: '100%' },
          { color: 'rgba(56, 146, 179, 0.45)', stop: '100%' },
          { color: 'rgba(56, 146, 179, 0.5)', stop: '100%' },
          { color: 'rgba(56, 146, 179, 0.45)', stop: '100%' },
          { color: 'rgba(56, 146, 179, 0.25)', stop: '100%' },
        ],
        blur: '0px',
    ...
    <div className='absolute inset-0 overflow-hidden pointer-events-none'>
      {activeGradients.map((gradient, index) => (
        <div
          ...
          style={{ background: generateGradient(gradient.colors), opacity: gradient.opacity, filter: `blur(${gradient.blur})` }}
        />
      ))} 
    </div>
  )
