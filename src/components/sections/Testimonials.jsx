...
const Testimonials = () => {
    ...
    const testimonialStats = [
        ...
        { value: '24–48 Hrs', label: 'Quick Dispatch' },
        { value: 'PAN UAE', label: 'Delivery Network' },
                ...
                <FadeIn delay={0}>
                    <div className='text-center mb-16'>
                        ...
                        <h2 className='text-4xl lg:text-5xl font-normal text-white mb-4 max-w-xl mx-auto'>
                            Trusted by Engineers, Contractors & Traders
                        </h2>

                        <p className='text-lg text-white/60 max-w-2xl mx-auto'>
                            Supplying reliable pipes, valves, and fittings to industries, infrastructure projects,
                            and retailers with consistent quality, competitive pricing, and timely delivery.
                        </p>
                    </div>
                </FadeIn>
                        ...
                        <div className='flex items-center justify-center gap-2 mt-10'>
                            {testimonials.map((_, index) => (
                                <button
                                    ...
                                    className={`transition-all duration-300 rounded-full ${index === currentIndex ? 'bg-white w-6 h-2' : 'bg-white/30 w-2 h-2 hover:bg-white/30'}`}
